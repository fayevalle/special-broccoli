...
function createTransaction(req, res, next) {
  ...
  db.none('insert into transaction_tbl(transaction, purpose, others,reference_number,user_id,date) values (${transaction}, ${purpose}, ${others}, ${userid}, ${reference_number}, ${date})',
    req.body)
    .then(function () {
      res.status(200)
        .json({
